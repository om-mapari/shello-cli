    ...
    ShelloTool(
        ...
        function={
            ...
            "description": (
                ...
                "- ALWAYS filter at source (jq, grep, head, Select-Object)\n"
                "- For AWS/cloud: pipe to jq for specific fields\n"
                "- For lists: limit with --max-items, head, Select-Object -First\n\n"
                "Examples:\n"
                ...
                "- For git/man/less: use --no-pager or alternatives to prevent hanging\n\n"
                "SAFETY:\n"
                "- is_safe=true: read-only (ls, cat, git status) - runs immediately\n"
